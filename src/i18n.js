...
const COPY = {
  en: {
    popup: {
      ...
      searchPlaceholder: 'Search title, ID, platform, or content',
      clearSearch: 'Clear',
      searchCount: '{visible} / {total} shown',
      contentMatch: 'Matched in chat content',
      refresh: 'Refresh',
      clear: 'Clear',
      noConversations: 'No captured conversations yet.',
      noSearchResults: 'No conversations match the current search.',
  ...
  zh: {
    popup: {
      ...
      toggleAll: '全选/全不选',
      searchLabel: '搜索会话',
      searchPlaceholder: '按标题、ID、平台或内容筛选',
      clearSearch: '清空搜索',
      searchCount: '显示 {visible} / {total}',
      contentMatch: '命中聊天内容',
      refresh: '刷新',
      clear: '清空',
      noConversations: '暂无已捕获会话。',
      noSearchResults: '没有匹配当前搜索条件的会话。',
      noEvents: '暂无最近事件。',
      pending: '待处理',
      failed: '失败',
      autoResume: '自动恢复',
